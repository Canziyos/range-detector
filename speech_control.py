...
DEVICE     = "cpu"
MODEL_PATH = os.getenv("SPEECH_MODEL_PATH", "speech_command/ckp/b_m_0.8298.pth")
AUDIO_DIR  = os.getenv("SPEECH_AUDIO_DIR", "speech_command/me")
THRESHOLD  = float(os.getenv("SPEECH_THRESHOLD", "0.70"))
CMD_URL    = os.getenv(
    "RANGE_DETECTOR_CMD_URL",
    "http://localhost:5000/status/sendcmd?cmd={}",
)
